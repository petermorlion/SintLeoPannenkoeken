namespace SintLeoPannenkoeken.Blazor.Client.Pages
{
    public class Hrefs
    {
        public const string Bestellingen = "verkoop/bestellingen";
        public const string Chauffeurs = "beheer/chauffeurs";
        public const string Rondes = "verdeling/rondes";
        ...
        public const string Straten = "beheer/straten";
